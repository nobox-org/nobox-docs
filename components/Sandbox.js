...
Markdoc uses a fully declarative approach to composition and flow control, where other solutions… [Read more](/overview).

## Next steps
- [Install Markdoc](/getting-started)
- [Explore the syntax](/syntax)
`;
