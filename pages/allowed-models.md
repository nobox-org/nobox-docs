...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| EleutherAI: Llemma 7b | eleutherai • text->text | `eleutherai/llemma_7b` | text->text | 4,096 | 0.0000008 | 0.0000012 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| Qrwkv 72B (free) | featherless • text->text | `featherless/qwerky-72b:free` | text->text | 32,768 | 0 | 0 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| Google: Gemini 1.5 Flash  | google • text+image->text | `google/gemini-flash-1.5` | text+image->text | 1,000,000 | 0.000000075 | 0.0000003 |
| Google: Gemini 1.5 Flash 8B | google • text+image->text | `google/gemini-flash-1.5-8b` | text+image->text | 1,000,000 | 0.0000000375 | 0.00000015 |
| Google: Gemini 1.5 Pro | google • text+image->text | `google/gemini-pro-1.5` | text+image->text | 2,000,000 | 0.00000125 | 0.000005 |
| Google: Gemini 2.0 Flash | google • text+image->text | `google/gemini-2.0-flash-001` | text+image->text | 1,048,576 | 0.0000001 | 0.0000004 |
| Google: Gemini 2.0 Flash Experimental (free) | google • text+image->text | `google/gemini-2.0-flash-exp:free` | text+image->text | 1,048,576 | 0 | 0 |
| Google: Gemini 2.0 Flash Lite | google • text+image->text | `google/gemini-2.0-flash-lite-001` | text+image->text | 1,048,576 | 0.000000075 | 0.0000003 |
| Google: Gemini 2.5 Flash | google • text+image->text | `google/gemini-2.5-flash` | text+image->text | 1,048,576 | 0.0000003 | 0.0000025 |
| Google: Gemini 2.5 Flash Lite | google • text+image->text | `google/gemini-2.5-flash-lite` | text+image->text | 1,048,576 | 0.0000001 | 0.0000004 |
| Google: Gemini 2.5 Flash Lite Preview 06-17 | google • text+image->text | `google/gemini-2.5-flash-lite-preview-06-17` | text+image->text | 1,048,576 | 0.0000001 | 0.0000004 |
| Google: Gemini 2.5 Pro | google • text+image->text | `google/gemini-2.5-pro` | text+image->text | 1,048,576 | 0.00000125 | 0.00001 |
| Google: Gemini 2.5 Pro Experimental | google • text+image->text | `google/gemini-2.5-pro-exp-03-25` | text+image->text | 1,048,576 | 0 | 0 |
| Google: Gemini 2.5 Pro Preview 05-06 | google • text+image->text | `google/gemini-2.5-pro-preview-05-06` | text+image->text | 1,048,576 | 0.00000125 | 0.00001 |
| Google: Gemini 2.5 Pro Preview 06-05 | google • text+image->text | `google/gemini-2.5-pro-preview` | text+image->text | 1,048,576 | 0.00000125 | 0.00001 |
| Google: Gemma 2 27B | google • text->text | `google/gemma-2-27b-it` | text->text | 8,192 | 0.00000065 | 0.00000065 |
| Google: Gemma 2 9B | google • text->text | `google/gemma-2-9b-it` | text->text | 8,192 | 0.00000001 | 0.0000000100008 |
| Google: Gemma 2 9B (free) | google • text->text | `google/gemma-2-9b-it:free` | text->text | 8,192 | 0 | 0 |
| Google: Gemma 3 12B | google • text+image->text | `google/gemma-3-12b-it` | text+image->text | 96,000 | 0.0000000481286 | 0.000000192608 |
| Google: Gemma 3 12B (free) | google • text+image->text | `google/gemma-3-12b-it:free` | text+image->text | 96,000 | 0 | 0 |
| Google: Gemma 3 27B | google • text+image->text | `google/gemma-3-27b-it` | text+image->text | 96,000 | 0.0000000666396 | 0.000000266688 |
| Google: Gemma 3 27B (free) | google • text+image->text | `google/gemma-3-27b-it:free` | text+image->text | 96,000 | 0 | 0 |
| Google: Gemma 3 4B | google • text+image->text | `google/gemma-3-4b-it` | text+image->text | 131,072 | 0.00000002 | 0.00000004 |
| Google: Gemma 3 4B (free) | google • text+image->text | `google/gemma-3-4b-it:free` | text+image->text | 32,768 | 0 | 0 |
| Google: Gemma 3n 2B (free) | google • text->text | `google/gemma-3n-e2b-it:free` | text->text | 8,192 | 0 | 0 |
| Google: Gemma 3n 4B | google • text->text | `google/gemma-3n-e4b-it` | text->text | 32,768 | 0.00000002 | 0.00000004 |
| Google: Gemma 3n 4B (free) | google • text->text | `google/gemma-3n-e4b-it:free` | text->text | 8,192 | 0 | 0 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| MiniMax: MiniMax M1 | minimax • text->text | `minimax/minimax-m1` | text->text | 1,000,000 | 0.0000003 | 0.00000165 |
| MiniMax: MiniMax-01 | minimax • text+image->text | `minimax/minimax-01` | text+image->text | 1,000,192 | 0.0000002 | 0.0000011 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| Mistral Large | mistralai • text->text | `mistralai/mistral-large` | text->text | 128,000 | 0.000002 | 0.000006 |
| Mistral Large 2407 | mistralai • text->text | `mistralai/mistral-large-2407` | text->text | 131,072 | 0.000002 | 0.000006 |
| Mistral Large 2411 | mistralai • text->text | `mistralai/mistral-large-2411` | text->text | 131,072 | 0.000002 | 0.000006 |
| Mistral Small | mistralai • text->text | `mistralai/mistral-small` | text->text | 32,768 | 0.0000002 | 0.0000006 |
| Mistral Tiny | mistralai • text->text | `mistralai/mistral-tiny` | text->text | 32,768 | 0.00000025 | 0.00000025 |
| Mistral: Codestral 2501 | mistralai • text->text | `mistralai/codestral-2501` | text->text | 262,144 | 0.0000003 | 0.0000009 |
| Mistral: Codestral 2508 | mistralai • text->text | `mistralai/codestral-2508` | text->text | 256,000 | 0.0000003 | 0.0000009 |
| Mistral: Devstral Medium | mistralai • text->text | `mistralai/devstral-medium` | text->text | 131,072 | 0.0000004 | 0.000002 |
| Mistral: Devstral Small 1.1 | mistralai • text->text | `mistralai/devstral-small` | text->text | 128,000 | 0.00000007 | 0.00000028 |
| Mistral: Devstral Small 2505 | mistralai • text->text | `mistralai/devstral-small-2505` | text->text | 32,768 | 0.00000001999188 | 0.0000000800064 |
| Mistral: Devstral Small 2505 (free) | mistralai • text->text | `mistralai/devstral-small-2505:free` | text->text | 32,768 | 0 | 0 |
| Mistral: Magistral Medium 2506 | mistralai • text->text | `mistralai/magistral-medium-2506` | text->text | 40,960 | 0.000002 | 0.000005 |
| Mistral: Magistral Medium 2506 (thinking) | mistralai • text->text | `mistralai/magistral-medium-2506:thinking` | text->text | 40,960 | 0.000002 | 0.000005 |
| Mistral: Magistral Small 2506 | mistralai • text->text | `mistralai/magistral-small-2506` | text->text | 40,000 | 0.0000005 | 0.0000015 |
| Mistral: Ministral 3B | mistralai • text->text | `mistralai/ministral-3b` | text->text | 32,768 | 0.00000004 | 0.00000004 |
| Mistral: Ministral 8B | mistralai • text->text | `mistralai/ministral-8b` | text->text | 128,000 | 0.0000001 | 0.0000001 |
| Mistral: Mistral 7B Instruct | mistralai • text->text | `mistralai/mistral-7b-instruct` | text->text | 32,768 | 0.000000028 | 0.000000054 |
| Mistral: Mistral 7B Instruct (free) | mistralai • text->text | `mistralai/mistral-7b-instruct:free` | text->text | 32,768 | 0 | 0 |
| Mistral: Mistral 7B Instruct v0.1 | mistralai • text->text | `mistralai/mistral-7b-instruct-v0.1` | text->text | 2,824 | 0.00000011 | 0.00000019 |
| Mistral: Mistral 7B Instruct v0.2 | mistralai • text->text | `mistralai/mistral-7b-instruct-v0.2` | text->text | 32,768 | 0.0000002 | 0.0000002 |
| Mistral: Mistral 7B Instruct v0.3 | mistralai • text->text | `mistralai/mistral-7b-instruct-v0.3` | text->text | 32,768 | 0.000000028 | 0.000000054 |
| Mistral: Mistral Medium 3 | mistralai • text+image->text | `mistralai/mistral-medium-3` | text+image->text | 131,072 | 0.0000004 | 0.000002 |
| Mistral: Mistral Nemo | mistralai • text->text | `mistralai/mistral-nemo` | text->text | 32,000 | 0.0000000075 | 0.00000005 |
| Mistral: Mistral Nemo (free) | mistralai • text->text | `mistralai/mistral-nemo:free` | text->text | 131,072 | 0 | 0 |
| Mistral: Mistral Small 3 | mistralai • text->text | `mistralai/mistral-small-24b-instruct-2501` | text->text | 32,768 | 0.00000001999188 | 0.0000000800064 |
| Mistral: Mistral Small 3 (free) | mistralai • text->text | `mistralai/mistral-small-24b-instruct-2501:free` | text->text | 32,768 | 0 | 0 |
| Mistral: Mistral Small 3.1 24B | mistralai • text+image->text | `mistralai/mistral-small-3.1-24b-instruct` | text+image->text | 131,072 | 0.000000017992692 | 0.00000007200576 |
| Mistral: Mistral Small 3.1 24B (free) | mistralai • text+image->text | `mistralai/mistral-small-3.1-24b-instruct:free` | text+image->text | 128,000 | 0 | 0 |
| Mistral: Mistral Small 3.2 24B | mistralai • text+image->text | `mistralai/mistral-small-3.2-24b-instruct` | text+image->text | 131,072 | 0.00000001999188 | 0.0000000800064 |
| Mistral: Mistral Small 3.2 24B (free) | mistralai • text+image->text | `mistralai/mistral-small-3.2-24b-instruct:free` | text+image->text | 131,072 | 0 | 0 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| NVIDIA: Llama 3.1 Nemotron 70B Instruct | nvidia • text->text | `nvidia/llama-3.1-nemotron-70b-instruct` | text->text | 131,072 | 0.00000012 | 0.0000003 |
| NVIDIA: Llama 3.1 Nemotron Ultra 253B v1 | nvidia • text->text | `nvidia/llama-3.1-nemotron-ultra-253b-v1` | text->text | 131,072 | 0.0000006 | 0.0000018 |
| NVIDIA: Llama 3.1 Nemotron Ultra 253B v1 (free) | nvidia • text->text | `nvidia/llama-3.1-nemotron-ultra-253b-v1:free` | text->text | 131,072 | 0 | 0 |
| NVIDIA: Llama 3.3 Nemotron Super 49B v1 | nvidia • text->text | `nvidia/llama-3.3-nemotron-super-49b-v1` | text->text | 131,072 | 0.00000013 | 0.0000004 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| OpenAI: ChatGPT-4o | openai • text+image->text | `openai/chatgpt-4o-latest` | text+image->text | 128,000 | 0.000005 | 0.000015 |
| OpenAI: Codex Mini | openai • text+image->text | `openai/codex-mini` | text+image->text | 200,000 | 0.0000015 | 0.000006 |
| OpenAI: GPT-3.5 Turbo | openai • text->text | `openai/gpt-3.5-turbo` | text->text | 16,385 | 0.0000005 | 0.0000015 |
| OpenAI: GPT-3.5 Turbo (older v0613) | openai • text->text | `openai/gpt-3.5-turbo-0613` | text->text | 4,095 | 0.000001 | 0.000002 |
| OpenAI: GPT-3.5 Turbo 16k | openai • text->text | `openai/gpt-3.5-turbo-16k` | text->text | 16,385 | 0.000003 | 0.000004 |
| OpenAI: GPT-3.5 Turbo Instruct | openai • text->text | `openai/gpt-3.5-turbo-instruct` | text->text | 4,095 | 0.0000015 | 0.000002 |
| OpenAI: GPT-4 | openai • text->text | `openai/gpt-4` | text->text | 8,191 | 0.00003 | 0.00006 |
| OpenAI: GPT-4 (older v0314) | openai • text->text | `openai/gpt-4-0314` | text->text | 8,191 | 0.00003 | 0.00006 |
| OpenAI: GPT-4 Turbo | openai • text+image->text | `openai/gpt-4-turbo` | text+image->text | 128,000 | 0.00001 | 0.00003 |
| OpenAI: GPT-4 Turbo (older v1106) | openai • text->text | `openai/gpt-4-1106-preview` | text->text | 128,000 | 0.00001 | 0.00003 |
| OpenAI: GPT-4 Turbo Preview | openai • text->text | `openai/gpt-4-turbo-preview` | text->text | 128,000 | 0.00001 | 0.00003 |
| OpenAI: GPT-4.1 | openai • text+image->text | `openai/gpt-4.1` | text+image->text | 1,047,576 | 0.000002 | 0.000008 |
| OpenAI: GPT-4.1 Mini | openai • text+image->text | `openai/gpt-4.1-mini` | text+image->text | 1,047,576 | 0.0000004 | 0.0000016 |
| OpenAI: GPT-4.1 Nano | openai • text+image->text | `openai/gpt-4.1-nano` | text+image->text | 1,047,576 | 0.0000001 | 0.0000004 |
| OpenAI: GPT-4o | openai • text+image->text | `openai/gpt-4o` | text+image->text | 128,000 | 0.0000025 | 0.00001 |
| OpenAI: GPT-4o (2024-05-13) | openai • text+image->text | `openai/gpt-4o-2024-05-13` | text+image->text | 128,000 | 0.000005 | 0.000015 |
| OpenAI: GPT-4o (2024-11-20) | openai • text+image->text | `openai/gpt-4o-2024-11-20` | text+image->text | 128,000 | 0.0000025 | 0.00001 |
| OpenAI: GPT-4o (extended) | openai • text+image->text | `openai/gpt-4o:extended` | text+image->text | 128,000 | 0.000006 | 0.000018 |
| OpenAI: GPT-4o Search Preview | openai • text->text | `openai/gpt-4o-search-preview` | text->text | 128,000 | 0.0000025 | 0.00001 |
| OpenAI: GPT-4o-mini | openai • text+image->text | `openai/gpt-4o-mini` | text+image->text | 128,000 | 0.00000015 | 0.0000006 |
| OpenAI: GPT-4o-mini (2024-07-18) | openai • text+image->text | `openai/gpt-4o-mini-2024-07-18` | text+image->text | 128,000 | 0.00000015 | 0.0000006 |
| OpenAI: GPT-4o-mini Search Preview | openai • text->text | `openai/gpt-4o-mini-search-preview` | text->text | 128,000 | 0.00000015 | 0.0000006 |
| OpenAI: GPT-5 | openai • text+image->text | `openai/gpt-5` | text+image->text | 400,000 | 0.00000125 | 0.00001 |
| OpenAI: GPT-5 Chat | openai • text+image->text | `openai/gpt-5-chat` | text+image->text | 400,000 | 0.00000125 | 0.00001 |
| OpenAI: GPT-5 Mini | openai • text+image->text | `openai/gpt-5-mini` | text+image->text | 400,000 | 0.00000025 | 0.000002 |
| OpenAI: GPT-5 Nano | openai • text+image->text | `openai/gpt-5-nano` | text+image->text | 400,000 | 0.00000005 | 0.0000004 |
| OpenAI: gpt-oss-120b | openai • text->text | `openai/gpt-oss-120b` | text->text | 131,072 | 0.00000009 | 0.00000045 |
| OpenAI: gpt-oss-20b | openai • text->text | `openai/gpt-oss-20b` | text->text | 131,072 | 0.00000004 | 0.00000016 |
...
| Model | Subtitle | ID | Modality | Context | Prompt $/1k | Completion $/1k |
| --- | --- | --- | --- | --- | --- | --- |
| Qwen 2 72B Instruct | qwen • text->text | `qwen/qwen-2-72b-instruct` | text->text | 32,768 | 0.0000009 | 0.0000009 |
| Qwen: Qwen VL Max | qwen • text+image->text | `qwen/qwen-vl-max` | text+image->text | 7,500 | 0.0000008 | 0.0000032 |
| Qwen: Qwen VL Plus | qwen • text+image->text | `qwen/qwen-vl-plus` | text+image->text | 7,500 | 0.00000021 | 0.00000063 |
| Qwen: Qwen-Max  | qwen • text->text | `qwen/qwen-max` | text->text | 32,768 | 0.0000016 | 0.0000064 |
| Qwen: Qwen-Plus | qwen • text->text | `qwen/qwen-plus` | text->text | 131,072 | 0.0000004 | 0.0000012 |
| Qwen: Qwen-Turbo | qwen • text->text | `qwen/qwen-turbo` | text->text | 1,000,000 | 0.00000005 | 0.0000002 |
| Qwen: Qwen2.5 VL 32B Instruct | qwen • text+image->text | `qwen/qwen2.5-vl-32b-instruct` | text+image->text | 16,384 | 0.00000001999188 | 0.0000000800064 |
| Qwen: Qwen2.5 VL 32B Instruct (free) | qwen • text+image->text | `qwen/qwen2.5-vl-32b-instruct:free` | text+image->text | 8,192 | 0 | 0 |
| Qwen: Qwen2.5 VL 72B Instruct | qwen • text+image->text | `qwen/qwen2.5-vl-72b-instruct` | text+image->text | 32,000 | 0.00000025 | 0.00000075 |
| Qwen: Qwen2.5 VL 72B Instruct (free) | qwen • text+image->text | `qwen/qwen2.5-vl-72b-instruct:free` | text+image->text | 32,768 | 0 | 0 |
| Qwen: Qwen2.5-VL 7B Instruct | qwen • text+image->text | `qwen/qwen-2.5-vl-7b-instruct` | text+image->text | 32,768 | 0.0000002 | 0.0000002 |
| Qwen: Qwen3 14B | qwen • text->text | `qwen/qwen3-14b` | text->text | 40,960 | 0.00000006 | 0.00000024 |
| Qwen: Qwen3 14B (free) | qwen • text->text | `qwen/qwen3-14b:free` | text->text | 40,960 | 0 | 0 |
| Qwen: Qwen3 235B A22B |  | `qwen/qwen3-235b-a22b` | text->text | 40,960 | 0.00000013 | 0.0000006 |
| Qwen: Qwen3 235B A22B (free) | qwen • text->text | `qwen/qwen3-235b-a22b:free` | text->text | 131,072 | 0 | 0 |
| Qwen: Qwen3 235B A22B Instruct 2507 | qwen • text->text | `qwen/qwen3-235b-a22b-2507` | text->text | 262,144 | 0.000000077968332 | 0.00000031202496 |
| Qwen: Qwen3 235B A22B Thinking 2507 | qwen • text->text | `qwen/qwen3-235b-a22b-thinking-2507` | text->text | 262,144 | 0.000000077968332 | 0.00000031202496 |
| Qwen: Qwen3 30B A3B | qwen • text->text | `qwen/qwen3-30b-a3b` | text->text | 40,960 | 0.00000001999188 | 0.0000000800064 |
| Qwen: Qwen3 30B A3B (free) | qwen • text->text | `qwen/qwen3-30b-a3b:free` | text->text | 40,960 | 0 | 0 |
| Qwen: Qwen3 30B A3B Instruct 2507 | qwen • text->text | `qwen/qwen3-30b-a3b-instruct-2507` | text->text | 131,072 | 0.0000002 | 0.0000008 |
| Qwen: Qwen3 32B | qwen • text->text | `qwen/qwen3-32b` | text->text | 40,960 | 0.000000017992692 | 0.00000007200576 |
| Qwen: Qwen3 4B (free) | qwen • text->text | `qwen/qwen3-4b:free` | text->text | 40,960 | 0 | 0 |
| Qwen: Qwen3 8B | qwen • text->text | `qwen/qwen3-8b` | text->text | 128,000 | 0.000000035 | 0.000000138 |
| Qwen: Qwen3 8B (free) | qwen • text->text | `qwen/qwen3-8b:free` | text->text | 40,960 | 0 | 0 |
| Qwen: Qwen3 Coder  | qwen • text->text | `qwen/qwen3-coder` | text->text | 262,144 | 0.0000001999188 | 0.000000800064 |
| Qwen: QwQ 32B | qwen • text->text | `qwen/qwq-32b` | text->text | 131,072 | 0.000000075 | 0.00000015 |
| Qwen: QwQ 32B (free) | qwen • text->text | `qwen/qwq-32b:free` | text->text | 32,768 | 0 | 0 |
| Qwen: QwQ 32B Preview | qwen • text->text | `qwen/qwq-32b-preview` | text->text | 32,768 | 0.0000002 | 0.0000002 |
| Qwen2.5 72B Instruct | qwen • text->text | `qwen/qwen-2.5-72b-instruct` | text->text | 32,768 | 0.0000000666396 | 0.000000266688 |
| Qwen2.5 72B Instruct (free) | qwen • text->text | `qwen/qwen-2.5-72b-instruct:free` | text->text | 32,768 | 0 | 0 |
| Qwen2.5 7B Instruct | qwen • text->text | `qwen/qwen-2.5-7b-instruct` | text->text | 65,536 | 0.00000004 | 0.0000001 |
| Qwen2.5 Coder 32B Instruct | qwen • text->text | `qwen/qwen-2.5-coder-32b-instruct` | text->text | 32,768 | 0.0000000499797 | 0.000000200016 |
| Qwen2.5 Coder 32B Instruct (free) | qwen • text->text | `qwen/qwen-2.5-coder-32b-instruct:free` | text->text | 32,768 | 0 | 0 |
